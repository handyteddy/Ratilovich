...
<img src="/assets/images/shibboleth/1*eBTJDQruemZplse733JDIw.png" height="100%" width="100%">
...
<img src="/assets/images/shibboleth/1*xrUMV-q8h7IhSIX7U8VGrw.png" height="100%" width="100%">
...
<img src="/assets/images/shibboleth/1*MxH7n3tx193M7wT7JlgODw.png" height="100%" width="100%">
...
<img src="/assets/images/shibboleth/1*_G1Q7m7FldBT-sOczCCbfA.png" height="100%" width="100%">

further check by way of subdomain enumeration reveals one web applications running on two different subdomains

“monitor” and “zabbix”

<img src="/assets/images/shibboleth/1*7eAU4863LtSgXQQ6jH_Hdw.png" height="100%" width="100%">
...
<img src="/assets/images/shibboleth/1*AhoLnOHcdibUntzhC1pTSw.png" height="100%" width="100%">
...
<img src="/assets/images/shibboleth/1*HWF9n46q1vWM-j66V6SAbA.png" height="100%" width="100%">*Zabbix 5.0.17 — Remote Code Execution (RCE) (Authenticated)*

running the exploit against the target we secure a shell as the user Zabbix

<img src="/assets/images/shibboleth/1*Yi9LrOUhR71vXAMkFP2OhA.png" height="100%" width="100%">
...
<img src="/assets/images/shibboleth/1*DUTeqOEF5Fbp3n0QJ2uIhQ.png" height="100%" width="100%">*user.txt*

**Horizontal Privileged Escalation**

By looking for credentials in configuration files

<img src="/assets/images/shibboleth/1*t7tK5zt1sqol6VN6HjjiBg.png" height="100%" width="100%">*using find to enumerate conf files*

we are able to read clear text database credentials in the **zabbix_server.conf **file

<img src="/assets/images/shibboleth/1*pW1zyqRlw-aK2Z6dcbsnIA.png" height="100%" width="100%">
...
<img src="/assets/images/shibboleth/1*izbR30PUK0u_pTt0U5v3Pg.png" height="100%" width="100%">*service version enumeration*
...
<img src="/assets/images/shibboleth/1*uV5W6MnEZ5okTWUNF2QzFA.png" height="100%" width="100%">*creating a elf binary with msfvenom*
...
<img src="/assets/images/shibboleth/1*jnQJobg2wJxSaJng3kKuwA.png" height="100%" width="100%">`mysql -u <user> -p -h <ip> -e 'SET GLOBAL wsrep_provider="/tmp/CVE-2021-27928.so";'`
